    ...
    <div className="AboutContainer">
      <div className="left">
        <div className="BioData">
          ...
          <div className="info">
            <p>
              I like developing devices based off hardware and software which
              are either interesting or useful.
            </p>
          </div>
        </div>
      ...
      <div className="right">
        <div className="projects">
          ...
          <div className="Project1">
            ...
            Designing a completly end-to-end Autonomous system for drones
            Achieved a complete autonomous takeoff and land till date
          </div>
          <div className="Project2">
            <div className="heading">M.A.R.S.Rover</div>
            Working on a Rover in which I am trying to collect depth data from
            the first principles. Trying to perform autonomous tasks using
            camera data
          </div>
